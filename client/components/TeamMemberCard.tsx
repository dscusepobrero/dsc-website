...
export default function TeamMemberCard({
  ...
  return (
    ...
    <div className="group relative flex-shrink-0 w-[320px] max-w-[calc(100vw-2rem)] mx-auto h-[482px] rounded-lg overflow-hidden shadow-[13px_13px_6.2px_0_rgba(239,79,31,0.25)] hover:shadow-[15px_15px_8px_0_rgba(239,79,31,0.3)] transition-all duration-300 ease-in-out hover:-translate-y-2">
      {/* Default State */}
      ...
      {/* Hover State */}
      <div className="absolute inset-0 flex flex-col items-center justify-center p-6 bg-dsc-maroon/70 opacity-0 group-hover:opacity-100 transition-opacity duration-300 ease-in-out">
        <img
          src={image}
          alt=""
          aria-hidden="true"
          className="absolute inset-0 w-full h-full object-cover opacity-60 blur-sm scale-125 transition-all duration-700 ease-in-out group-hover:scale-140 group-hover:blur-[2px]"
        />
        <div className="relative text-center text-white flex flex-col h-full w-full">
          <div className="flex-1 flex flex-col items-center justify-center">
            <h3 className="font-rethink font-bold text-3xl mb-1 transform transition-all duration-300 ease-in-out delay-150 opacity-0 translate-y-6 group-hover:opacity-100 group-hover:translate-y-0">
              {name}
            </h3>
            <p className="font-rethink text-lg mb-4 transform transition-all duration-300 ease-in-out delay-200 opacity-0 translate-y-6 group-hover:opacity-100 group-hover:translate-y-0">
              {role}
            </p>
            <p className="font-rethink text-base italic max-w-xs transform transition-all duration-300 ease-in-out delay-250 opacity-0 translate-y-6 group-hover:opacity-100 group-hover:translate-y-0">
              "{quote}"
            </p>
          </div>
