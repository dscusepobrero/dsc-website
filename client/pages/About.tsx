  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="w-full">
        ...
        <div className="w-full h-[37px] bg-gradient-to-b from-dsc-orange/50 to-transparent" style={{ background: "linear-gradient(180deg, rgba(239, 79, 31, 0.50) 1.94%, rgba(239, 79, 31, 0.00) 99.88%), #801817" }}></div>

        <section className="relative bg-gradient-to-b from-transparent via-transparent to-dsc-orange/50 bg-dsc-maroon px-6 sm:px-12 lg:px-24 py-12 sm:py-16 lg:py-20 overflow-hidden">
          <svg
            className="absolute -left-20 sm:-left-40 lg:-left-60 top-0 w-[250px] sm:w-[400px] lg:w-[507px] h-auto opacity-10 pointer-events-none"
            width="303"
            height="510"
            viewBox="0 0 303 510"
            fill="none"
          ...
          >
            <ellipse
              ...
              rx="253.5"
              ry="261"
              transform="rotate(-109.94 41.8045 255.312)"
              fill="#D9D9D9"
              fillOpacity="0.1"
            />
          </svg>
          ...
          <svg
            className="absolute top-20 sm:top-32 lg:top-40 left-4 sm:left-8 lg:left-16 w-[180px] sm:w-[240px] lg:w-[292px] h-auto opacity-15 pointer-events-none"
            width="292"
            height="300"
            viewBox="0 0 292 300"
            fill="none"
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <h2 className="font-inter font-bold text-white text-3xl sm:text-4xl lg:text-[50px] leading-tight mb-8 sm:mb-12">
              OUR MISSION
            </h2>

            <p className="font-rethink text-white text-lg sm:text-xl lg:text-2xl leading-relaxed max-w-6xl">
        ...
        <section className="relative bg-gradient-to-b from-transparent via-transparent to-dsc-orange/50 bg-dsc-maroon px-6 sm:px-12 lg:px-24 py-12 sm:py-16 lg:py-20 overflow-hidden">
          <svg
            className="absolute -right-20 sm:-right-32 top-0 w-[250px] sm:w-[400px] lg:w-[507px] h-auto opacity-10 pointer-events-none"
            width="215"
            height="522"
            viewBox="0 0 215 522"
            fill="none"
          ...
          <svg
            className="absolute right-0 top-40 sm:top-52 lg:top-64 w-[180px] sm:w-[240px] lg:w-[292px] h-auto opacity-15 pointer-events-none"
            width="292"
            height="300"
            viewBox="0 0 292 300"
            fill="none"
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            <div className="font-rethink text-white text-lg sm:text-xl lg:text-2xl leading-relaxed space-y-6 max-w-6xl">
              <p>
