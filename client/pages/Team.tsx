    ...
    <div className="min-h-screen bg-white relative overflow-hidden">
      ...
      <main className="relative">
        ...
        <div className="relative">
          <svg
            className="absolute w-[507px] h-[522px] right-0 top-0 pointer-events-none"
            viewBox="0 0 507 522"
            fill="none"
          >
            <ellipse
          ...
          <svg
            className="absolute w-[292px] h-[300px] right-[100px] top-[250px] pointer-events-none"
            viewBox="0 0 292 300"
            fill="none"
          >
            <ellipse
        ...
        <div className="relative">
          <svg
            className="absolute w-[101px] h-[103px] right-[100px] top-0 pointer-events-none"
            viewBox="0 0 101 103"
            fill="none"
          >
            <ellipse
        ...
        <div className="relative">
          <svg
            className="absolute w-[507px] h-[522px] -left-[173px] top-[100px] pointer-events-none"
            viewBox="0 0 507 522"
            fill="none"
          >
            <ellipse
          ...
          <svg
            className="absolute w-[292px] h-[300px] left-[137px] top-[350px] pointer-events-none"
            viewBox="0 0 292 300"
            fill="none"
          >
            <ellipse
        ...
        <div className="relative">
          <svg
            className="absolute w-[616px] h-[634px] right-0 top-0 pointer-events-none"
            viewBox="0 0 616 634"
            fill="none"
          >
            <ellipse
          ...
          <svg
            className="absolute w-[231px] h-[237px] right-[50px] top-0 pointer-events-none"
            viewBox="0 0 231 237"
            fill="none"
          >
            <ellipse
        ...
        <div className="relative">
          <svg
            className="absolute w-[616px] h-[634px] -left-[285px] top-0 pointer-events-none"
            viewBox="0 0 616 634"
            fill="none"
          >
            <ellipse
          ...
          <svg
            className="absolute w-[231px] h-[237px] left-[3px] top-0 pointer-events-none"
            viewBox="0 0 231 237"
            fill="none"
          >
            <ellipse
